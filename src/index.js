...
var base = Rebase.createClass({
  apiKey: "AIzaSyBkZlUQ56KiwhrZ_nnRRGSQvD4tt3i60QA",   // replace with your Firebase application's API key
  databaseURL: "https://buyflix-26ea1.firebaseio.com/", // replace with your Firebase application's database URL
})
...
var App = React.createClass({
    ...
    if (this.state.currentView === 'map') {
      return (
        ...
        <h3><Gmaps width={'100%'}
               ...
               lng={'-87.6285782'}
               zoom={11}
               loadingMessage={'Movie Theatres coming soon ... ironic or punny?'}
  ...
  movieCompareByTitle: function compare(movieA, movieB) {
